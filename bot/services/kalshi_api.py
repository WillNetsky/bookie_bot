...
def _is_market_bettable(m: dict) -> bool:
    """Return True if the market's YES price is between 1¢ and 99¢ (1%–99%).

    Filters out completed-but-unsettled markets whose prices have drifted
    to 0 or 1 (no longer trading).
    """
    try:
